...
<html class="no-js" lang="">
    <head>
        ...
        <title> Admin Pannel || banner </title>
    	...
    	<div class="tamplate clear">
    		...
    		<section class="content_section clear">
    			...
    			<div class="content_right clear">
                    <div class="content">
                        <h2> Update Banner Profile.. </h2>
                        <form action="banner_post.php" method="post" enctype="multipart/form-data">
                            <table class="table">
                                
                                    <td class="user_info"> banner_images : </td>
                                     <td> <input type="file" name="banner_images" placeholder="Update your phone number" >
                                     </td>

                                <tr>
                                    <td class="user_info">  banner_title : </td>
                                    <td> <input type="text" name="banner_title" placeholder="Update your website name" >
                                     </td>
                                </tr>

                                <tr>
                                    <td colspan="2"> <input type="submit" value="Update-Banner">
                                     </td>
                                </tr>
                            </table>
                        </form>
