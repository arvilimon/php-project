    	...
    	<div class="tamplate clear">
    		...
    		<section class="content_section clear">
    			...
    			<div class="content_right clear">
                    <div class="content">
                        <h2> Update manu Profile.. </h2>
                        <form action="menu_post.php" method="post">
                            <table class="table">
                                
                                <tr>
                                    <td class="user_info">  Logo-name : </td>
                                    <td> <input type="text" name="name" placeholder="Update your website name" >
                                     </td>
                                </tr>

                               
                                    <td class="user_info"> phone : </td>
                                     <td> <input type="text" name="phone" placeholder="Update your phone number" >
                                     </td>

                                <tr>
                                    <td colspan="2"> <input type="submit" value="Update-menu">
                                     </td>
                                </tr>
                            </table>
                        </form>
