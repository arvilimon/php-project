    		...
    		<section class="content_section clear">
    			...
    			<div class="content_right clear">
                    <div class="content">
                        ...
                        <form action="servic_post.php" method="post" enctype="multipart/form-data">
                            <table class="table">

                                  <tr>
                                    <td class="user_info"> servic_image </td>
                                    <td> <input type="file" name="servic_image"></td>
                                </tr>


                                    <td class="user_info"> servic_title </td>
                                     <td>
                                        <input type="text" name="servic_title">
                                     </td>
                                

                                <tr>
                                    <td class="user_info">servic_description</td>
                                     <td> 
                                        <textarea name="servic_description" rows="2" cols="20"></textarea>
                                     </td>
                                </tr>

                                <tr>
                                    <td colspan="2"> <input type="submit" value="Update-service">
                                     </td>
                                </tr>
                            </table>
                        </form>
